...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = noanet_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( noanet_get_config('preload') ) { ?>
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php $header = apply_filters( 'noanet_get_header_layout', noanet_get_config('header_type') );
		if ( empty($header) ) {
			$header = 'default';
		}
	?>
