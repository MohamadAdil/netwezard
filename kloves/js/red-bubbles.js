 ...
 * Constructor
 */
function Animate(redCanvas, options) {
...
Animate.prototype.init = function () {
  ...
  // Setup redCanvas
  this.redCanvas.width = this.width;
  this.redCanvas.height = this.height;

  this.ctx = redCanvas.getContext('2d');
...
/**
 * Make sure the redCanvas is the right size
 */
 ...
 * @param    ctx        {Object}     redCanvas context to draw on
...
new Animate(document.getElementById('redCanvas'));
