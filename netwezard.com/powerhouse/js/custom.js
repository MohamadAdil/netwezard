...
// Smoothscroll js
 ...
 // Add overflow hidden class in body on mobile
 if ( $(window).width() <= 768 ){
    $('.header-mobile__sticky__burger').click(function() {
        $('body').addClass('overflowhidden'); 
    });
    $('.header-mobile__sticky__cross').click(function() {
